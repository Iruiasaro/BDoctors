            ...
            <div v-if="!isLoading" class="suggested-doctors d-flex flex-wrap">
                <div v-for="doctor in filterResult" class="card" style="">
                    <div class="card-img-top overflow-hidden" style="min-height:200px">
                        ...
                        <img v-else :src="doctor.image.includes('random')?doctor.image:'storage/' + doctor.image"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-2 mb-2"> <i v-for="index in Math.round(doctor.voteAverage)"
                                class="fa fa-star third-color"> </i></div>
